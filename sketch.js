...
function setup() {
  ...
  obstacles.push(new CircularObstacle(windowWidth / 2, 200));
  obstacles.push(new CircularObstacle(windowWidth / 2, -400));
  obstacles.push(new CircularObstacle(windowWidth / 2, -1000));
